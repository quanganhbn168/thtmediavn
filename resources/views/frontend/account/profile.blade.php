    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-9">
                ...
                @endif
                @if($errors->any())
                    <div class="alert alert-critical">{{ $errors->first() }}</div>
                @endif
                ...
                <div class="content-card mb-3">
                    ...
                    @forelse($addresses as $address)
                        <div class="d-flex justify-content-between gap-3 py-3 border-bottom">
                            ...
                            <form action="{{ route('account.addresses.destroy', $address) }}" method="post">@csrf @method('DELETE')<button class="btn btn-sm btn-outline-critical">Xóa</button></form>
                        </div>
                    @empty
