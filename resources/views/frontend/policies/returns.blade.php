...
<section class="section-space bg-soft">
    <div class="container"><article class="content-card policy-content mx-auto">
        ...
        <p>Giữ nguyên sản phẩm, tem và bao bì; chụp lại tình trạng nhận hàng rồi liên hệ THT MEDIA VN trước khi gửi sản phẩm về. Hệ thống sẽ kiểm tra trường hợp giao nhầm, thiếu hàng hoặc lỗi sản phẩm và hướng dẫn phương án phù hợp.</p>
