...
@section('content')
    <form id="admin-save-form" action="{{ route('admin.product-options.store') }}" method="POST">
        @csrf
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                ...
                <x-card type="secondary" :outline="true" title="Giá trị thuộc tính" :collapsible="true">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <p class="text-muted mb-0">Khai báo các lựa chọn mà khách có thể chọn cho thuộc tính này.</p>
            ...
            <div class="col-lg-4">
                <x-card type="info" :outline="true" title="Cách hiển thị" :collapsible="true" class="mb-4">
                    ...
                    <x-input name="sort_order" type="number" label="Thứ tự hiển thị" :value="old('sort_order', 0)" min="0" step="1" />

                    <div class="border-top pt-3">
                        <input type="hidden" name="is_active" value="0">
                        <div class="form-check form-switch">
                            <input class="form-check-input cursor-pointer" type="checkbox" role="switch" name="is_active" id="product_option_is_active" value="1" @checked((bool) old('is_active', true))>
        ...
        <div class="d-flex flex-wrap justify-content-end gap-2 mt-4 mb-5">
            ...
            <button class="btn btn-primary" type="submit"><i class="bi bi-plus-lg me-1"></i>Tạo thuộc tính</button>
        </div>
    </form>
@endsection
