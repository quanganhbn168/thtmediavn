...
@section('title', 'Thêm ảnh trình chiếu')
@section('page-title', 'Thêm ảnh trình chiếu')
...
@section('content')
<form id="admin-save-form" action="{{ route('admin.slider-items.store') }}" method="POST">
    @csrf
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-7">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <x-input name="title" label="Tiêu đề" :translatable="true" />
                    <x-input name="sub_title" label="Phụ đề" :translatable="true" />

                    <div class="row">
                        <div class="col-md-6">
                            <div class="border rounded p-3 mb-3 h-100">
                                <h6 class="mb-3"><i class="bi bi-cursor-fill me-1 text-primary"></i>Nút liên kết 1</h6>
                                <x-input name="button_text_1" label="Nhãn nút" :translatable="true" />
                                <x-input name="button_link_1" label="Đường dẫn" placeholder="/san-pham hoặc https://..." />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="border rounded p-3 mb-3 h-100">
                                <h6 class="mb-3"><i class="bi bi-cursor me-1 text-primary"></i>Nút liên kết 2</h6>
                                <x-input name="button_text_2" label="Nhãn nút" :translatable="true" />
                                <x-input name="button_link_2" label="Đường dẫn" placeholder="/lien-he hoặc https://..." />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-6">
                            <x-input name="sort_order" type="number" label="Thứ tự hiển thị" :value="0" min="0" max="9999" :required="true" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-check form-switch">
                                <input type="hidden" name="is_active" value="0">
                                <input class="form-check-input" type="checkbox" role="switch" name="is_active" id="slider_item_is_active" value="1" @checked((bool) old('is_active', true))>
    ...
    <div class="d-flex justify-content-end gap-2 mt-3">
        <a href="{{ route('admin.sliders.edit', $slider) }}" class="btn btn-default"><i class="bi bi-x-lg me-1"></i>Hủy</a>
        <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i>Thêm ảnh</button>
    </div>
</form>
@endsection
