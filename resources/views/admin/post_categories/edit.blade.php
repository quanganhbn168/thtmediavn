...
@section('content')
    <form id="admin-save-form" action="{{ route('admin.post-categories.update', $postCategory->id) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="col-md-4 mb-4">
                ...
                <x-card type="info" :outline="true" title="Cấu hình hiển thị" :collapsible="true" class="mb-4">
                    ...
                    <x-input 
                        ...
                        :value="$postCategory->sort_order" 
                    />

                    <div class="mb-3 border-top pt-3">
                        <label class="form-label font-weight-bold d-block">Hiển thị trang chủ</label>
                        <div class="form-check form-switch">
                            <input class="form-check-input cursor-pointer" type="checkbox" role="switch" name="is_home" id="is_home" value="1" @checked(old('is_home', $postCategory->is_home))>
                    ...
                    <div class="mb-3 border-top pt-3">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input cursor-pointer" type="checkbox" role="switch" name="is_active" id="is_active" value="1" {{ $postCategory->is_active ? 'checked' : '' }}>
