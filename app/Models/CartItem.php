...
{
    protected $fillable = ['cart_id', 'product_id', 'product_variant_id', 'combo_id', 'quantity'];
    ...
    public function isCombo(): bool { return $this->combo_id !== null; }

    public function getUnitPriceAttribute(): float
    {
        if ($this->combo) return (float) $this->combo->price;
